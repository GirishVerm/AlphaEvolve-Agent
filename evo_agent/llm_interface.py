...
class LLMConfig:
    ...
    # Azure OpenAI settings - will be loaded from environment
    azure_endpoint: str = ""
...
class LLMInterface:
    ...
    def __init__(self, config: Optional[LLMConfig] = None):
        ...
        if not self.config.api_key:
            raise ValueError("API key not found. Please set AZURE_OPENAI_API_KEY or OPENAI_API_KEY environment variable.")
